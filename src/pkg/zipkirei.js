...
export class RepairResult {
    ...
    get log() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.repairresult_log(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            deferred1_0 = r0;
            deferred1_1 = r1;
 ...
 * @param {boolean} not_utf8
 * @param {boolean} keep_backslashes
 * @param {boolean} no_default_exclude
 * @returns {RepairResult}
 */
export function repair_zip(zip_data, dry_run, not_utf8, keep_backslashes, no_default_exclude) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(zip_data, wasm.__wbindgen_export);
        const len0 = WASM_VECTOR_LEN;
        wasm.repair_zip(retptr, ptr0, len0, dry_run, not_utf8, keep_backslashes, no_default_exclude);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('zipkirei_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
